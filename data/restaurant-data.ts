...
export const restaurantData: RestaurantData = {
  ...
  translations: {
    en: {
      ...
      completed: 'Completed',
      upcoming: 'Upcoming',
      add_items_to_continue: 'Add items to your cart to continue',
    ...
    fr: {
      ...
      completed: 'Terminé',
      upcoming: 'À venir',
      add_items_to_continue: 'Ajoutez des articles à votre panier pour continuer',
      review_title: 'Vérifier la commande',
    },
    nl: {
      food: 'Eten',
      drinks: 'Dranken',
      ...
      // Navigation
      order_progress: 'Bestelvoortgang',
      step: 'Stap',
      of: 'van',
      go_to_previous_step: 'Ga naar vorige stap',
      go_to_next_step: 'Ga naar volgende stap',
      current_step: 'Huidige stap',
      completed: 'Voltooid',
      upcoming: 'Binnenkort',
      add_items_to_continue: 'Voeg items toe aan je winkelwagen om door te gaan',
      review_title: 'Bestelling controleren',
    },
    de: {
      food: 'Essen',
      drinks: 'Getränke',
      ...
      step: 'Schritt',
      of: 'von',
      go_to_previous_step: 'Zum vorherigen Schritt gehen',
      go_to_next_step: 'Zum nächsten Schritt gehen',
      current_step: 'Aktueller Schritt',
      completed: 'Abgeschlossen',
      upcoming: 'Bevorstehend',
      add_items_to_continue: 'Fügen Sie Artikel zu Ihrem Warenkorb hinzu, um fortzufahren',
      review_title: 'Bestellung überprüfen',
    },
    es: {
      food: 'Comida',
      drinks: 'Bebidas',
      ...
      upcoming: 'Próximo',
      add_items_to_continue: 'Añade artículos a tu carrito para continuar',
      review_title: 'Revisar pedido',
    },
    it: {
      food: 'Cibo',
      drinks: 'Bevande',
      ...
      // Navigation
      order_progress: 'Progresso ordine',
      step: 'Passo',
      of: 'di',
      go_to_previous_step: 'Vai al passo precedente',
      go_to_next_step: 'Vai al prossimo passo',
      current_step: 'Passo corrente',
      completed: 'Completato',
      upcoming: 'Prossimo',
      add_items_to_continue: 'Aggiungi articoli al carrello per continuare',
      review_title: 'Rivedi ordine',
    },
  },
};
